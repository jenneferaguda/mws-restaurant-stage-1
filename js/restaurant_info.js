    ...
    fetchRestaurantFromURL((error, restaurant) => {
        if (error) { // Got an error!
            ...
            L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
                mapboxToken: 'pk.eyJ1IjoiamVuY2FwaWxpIiwiYSI6ImNqd3pxN2ZrbjFmaHA0M3IxNTNybGRqMXgifQ.OpLeGf2sGdCjgzZW8lfZrA',
                maxZoom: 18,
...
fillRestaurantHTML = (restaurant = self.restaurant) => {
    ...
    const imgURL800w = imgURL;
    image.src = imgURL320w;
    image.srcset = `${imgURL320w} 320w, ${imgURL600w} 600w, ${imgURL800w} 800w`;
...
fillBreadcrumb = (restaurant = self.restaurant) => {
    ...
    let attribute = document.createAttribute('aria-current');
